...
```{r Plots: Cost Curves, echo=FALSE, message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
...
```{r Plots: Global Maps, echo=FALSE, message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
plotdata<-alldata
...
```{r Plots: Wave Reduction Versus Widths,echo=FALSE, message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
#Reefs
...
```{r Plots: Wave Reduction Versus Incoming Wave Heights,echo=FALSE, message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
...
```{r Plots: Dimensionless Parameter Trends - Reefs,echo=FALSE, message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
#H/h
wvdata<-subset(alldata,alldata$HsC!=1)
#Reefs
...
```{r Plots: Dimensionless Parameter Trends - Salt-Marshes,echo=FALSE, message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
...
```{r,echo=FALSE,results="hide", message=FALSE,warning=FALSE, fig.width=12, fig.height=8}
#Hbyh #Others
